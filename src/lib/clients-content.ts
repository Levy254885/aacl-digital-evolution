export type ClientLogo = { name: string; logo: string; width: number; height: number };
...
export const CLIENT_LOGOS: ClientLogo[] = [
  ...
  {
    name: "ICPS — Intelligent Card Production Systems",
    logo: "/clients/icps.jpg",
    width: 200,
    height: 200,
  },
  { name: "Medical Access", logo: "/clients/medical-access.png", width: 225, height: 225 },
  {
    name: "Minimal Frame Projects",
    logo: "/clients/minimal-frame-projects.png",
    width: 225,
    height: 225,
  },
  {
    name: "Reeds Africa Consult",
    logo: "/clients/reeds-africa-consult.png",
    width: 225,
    height: 224,
  },
